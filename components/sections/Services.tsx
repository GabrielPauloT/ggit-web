        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {services.map((service, index) => (
            <motion.div
              ...
              className="group cursor-pointer bg-white/[0.02] border border-white/[0.05] hover:border-brand-blue/50 hover:bg-white/[0.04] rounded-3xl transition-all duration-500 relative overflow-hidden flex flex-col"
            >
              <div className={`h-32 bg-gradient-to-br ${service.gradient} relative flex items-center justify-center border-b border-white/[0.05]`}>
                ...
                <div className="p-4 bg-black/40 backdrop-blur-xl border border-white/10 rounded-2xl group-hover:scale-110 group-hover:border-brand-blue/40 transition-all duration-500 shadow-[0_0_20px_rgba(0,0,0,0.5)]">
              ...
              <div className="p-8 flex flex-col flex-grow">
                ...
                <div className="flex flex-wrap gap-2 pt-4 border-t border-white/[0.05]">
                  {service.tags.map((tag) => (
                    <span key={tag} className="text-xs text-gray-500 border border-white/[0.08] px-3 py-1 rounded-full bg-white/[0.02] group-hover:border-brand-blue/30 group-hover:text-gray-400 transition-all duration-500">
                      {tag}
                    </span>
                  ))}
                </div>
