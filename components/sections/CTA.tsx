      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        >
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6 tracking-tight">
            Ready to build<span className="text-transparent bg-clip-text bg-gradient-to-r from-brand-blue to-brand-cyan drop-shadow-[0_0_15px_rgba(245,158,11,0.4)]">?</span>
          </h2>
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.98 }}
            className="group relative cursor-pointer bg-gradient-to-r from-brand-blue to-brand-cyan text-white px-10 py-4 rounded-full font-semibold text-lg transition-all duration-300 shadow-[0_0_30px_rgba(245,158,11,0.3)] hover:shadow-[0_0_50px_rgba(6,182,212,0.4)] flex items-center gap-3 mx-auto overflow-hidden"
          >
