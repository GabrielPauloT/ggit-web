    ...
    <div className={`fixed left-0 right-0 z-50 transition-all duration-500 flex justify-center ${scrolled ? 'top-4 px-4' : 'top-0'}`}>
      ...
      >
        ...
        >
          ...
          <span className="text-brand-blue group-hover:text-brand-cyan transition-colors ml-0.5 drop-shadow-[0_0_8px_rgba(245,158,11,0.8)] group-hover:drop-shadow-[0_0_12px_rgba(6,182,212,0.8)]">.</span>
        </Link>
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="absolute top-full left-0 right-0 mt-2 bg-[#0a0a0a]/95 backdrop-blur-xl border border-white/10 rounded-2xl overflow-hidden md:hidden shadow-[0_8px_32px_rgba(0,0,0,0.6)]"
          >
