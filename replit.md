...
3. Stats (inline metrics with vertical dividers — clean, minimal)
4. About (two-column: company story left + 3D cube right, 4 pillar cards below incl. AI-Driven)
5. TechStack / "Under the Hood" (animated code block + tech tags grid — shows real architecture)
