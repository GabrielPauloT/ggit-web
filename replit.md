...
3. Stats (key metrics)
4. About (two-column: company story left + 3D cube right, 3 pillar cards below)
5. Services / "How We Build" (6 cards: PoC/MVP, No-Code to High-Code, Custom Software, Mobile, AI, IoT)
6. Portfolio / "Selected Works" (8 real projects with impact metrics)
7. CTA / "Ready to build?" (call-to-action with gradient button)
8. Footer (contact info, social links to GitHub/LinkedIn/Email, services list)
